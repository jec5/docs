...
There is a short deployment process that needs to complete before your incentive becomes officially _Open-Active_. You can check its status on the Deployments page. Even when the deployment has finished, it may still take a few more minutes for the status of your incentive to reflect this.
