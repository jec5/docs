...
<Card title="Build your blueprint" icon="object-group" horizontal href="https://fieloblueprint.com" img="/images/loyalty-designer-example-fitpro-rewards.png" cta="Start a canvas">
