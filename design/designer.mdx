...
<Card title="Build your blueprint" icon="object-group" horizontal href="https://fieloloyaltydevweb1.azurewebsites.net" img="/images/loyalty-designer-example-fitpro-rewards.png" cta="Start a canvas">
