...
<Columns cols={2}>
  <Column>
    <Card title="Program Copilot" icon="sparkles" href="/build/programs#program-copilot">
      Program performance reviews and incentive impact comparisons with interactive drilldowns.
    </Card>
  </Column>
  <Column>
    <Card title="Incentive Copilot" icon="wand-magic-sparkles" href="/build/incentives-config#configure-an-incentive-with-ai">
...
<Columns cols={2}>
  <Column>
    <Card title="Segment Copilot" icon="user-tag" href="/build/segments#configure-a-criteria-segment-with-ai-coming-soon">
      Chat-based ideation, creation and editting of segments leveraging your set of member attributes.
    </Card>
  </Column>
  <Column>
    <Card title="Recommendations Copilot" icon="thumbs-up" href="/build/programs#review-digest-recommendations-coming-soon">
