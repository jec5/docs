...
- _Last Activity Date Time_: The most recent day and time that the member was rewarded via an incentive rule or made a redemption.
...
- _Resolved-BlockAccruals_: The member is blocked from receiving rewards (including instant rewards), but can still use any active currency.
- _Resolved-BlockAll_: The member is blocked from receiving rewards and using currency.
- _Resolved-Inactive_: The member is no longer in the program. The member cannot receive rewards or use currency.