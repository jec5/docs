...
- _Resolved-Expired_: The entry is positive and any unused balance has been expired.
- _Resolved-Closed_: The entry is negative (redemption, expiration or negative adjustment) or the entry is positive and completely consumed.