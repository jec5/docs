...
You can brainstorm and create an incentive by chatting with Fielo Copilot. On the right side of the Incentives page, simply start a conversation around your incentive idea.

<video src="/videos/incetivesviaai3.mp4" controls={true} />

Copilot will ask for any missing information and confirm all details before creating your incentive. Once your incentive is created, you'll need to review it and then activate it.
...
For each incentive rule, there is a deployment process that needs to complete before it can become _Open-Active_. You can check the process' status on the Deployments page. Even when the deployment has finished, it may still take a few more minutes for the status of the incentive rule to reflect this.
...
- _New_: The incentive was created via Fielo Copilot and requires review prior to activation.
...
- _New_: The rule was created via Fielo Copilot and requires review prior to activation.
