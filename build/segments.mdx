...
![Segment Awaiting Criteria](/images/segment-awaiting-criteria.png)

### Configure a Criteria Segment with AI (Coming Soon)

You can brainstorm and create a segment by chatting with Fielo Copilot. On the right side of the Segments page, simply start a conversation around your segment idea.

Copilot will ask for any missing information and confirm all details before creating your segment. Once your segment is created, you'll need to review it and then activate it.

<Info>
  If a segment idea requires an attribute that doesn't currently exist, Copilot will let you know. Reach out to your account executive to explore how we can bring it to life.
</Info>
...
![Segment Define Criteria](/images/segment-define-criteria.png)
...
- _Pending-Deploy_: The segment has been submitted for activation and is undergoing deployment. This status applies to criteria segments only.
