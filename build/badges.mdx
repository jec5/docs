...
A badge can be given as an incentive reward. The badge expiration policy is defined on the incentive rule. If a badgeholder earns a badge again, the badge expiration date is extended to reflect the most recent earn date.

### Give a Badge Administratively

Admins can grant a badge manually and set its expiration date for that particular badgeholder.
